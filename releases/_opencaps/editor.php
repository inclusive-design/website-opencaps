...
<script language="javascript" type="text/javascript" src="js/editor.js"></script>					
	...
	<div id="movie-container">		
		...
		<param name="src" value="<?php echo "loadmedia.php?loc=".$this_proj->media_loc; ?>" />
		<param name="enablejavascript" value="true" />
		<param name="postdomevents" value="true" />
		<param name="controller" value="false" />
		<param name="autoplay" value="false" />
		<param name="scale" value="aspect" />
		<embed src="<?php echo "loadmedia.php?loc=".$this_proj->media_loc; ?>" width="340" height="<?php echo $this_proj->media_height; ?>" pluginspage="http://www.apple.com/quicktime/download/" enablejavascript="true" name="mymovie" id="mymovie_embed" postdomevents="true" controller="false" autoplay="false" scale="aspect" />
		</object>
	
	<?php 
	//$uri = explode($remote_systems[$_SESSION["rid"]]['url'], $this_proj->media_loc);
	//$uri = $uri[1];
	//echo matterhornAuth(0, $uri, "media"); ?>			
		...
		<div id="clip-controls">
			...
			<div style="text-align:center; margin-top:5px;">		
				...
				<a href="#" onclick="clip.normPlay()"><img src="images/play.png" alt="Play" title="Play" id="clip-playButton" /></a>&nbsp;
