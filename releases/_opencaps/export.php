...
<div id="content">
	...
	<?php if (isset($remote_systems) && isset($_SESSION['rid'])) { ?>
	<h3>Send Captions to Matterhorn</h3>					
		<p>If you are finished captioning this project, use the button below to update the system with your caption file.</p>
		<p><input type="submit" name="remote_submit" value="Submit Captions to Matterhorn" /></p><br />
	<?php }  ?>
